...
alias cl='clear'
alias sbus='ros2 run sbus_driver sbus_publisher'
# Add an "alert" alias for long running commands.  Use like so:
#   sleep 10; alert
alias alert='notify-send --urgency=low -i "$([ $? = 0 ] && echo terminal || echo error)" "$(history|tail -n1|sed -e '\''s/^\s*[0-9]\+\s*//;s/[;&|]\s*alert$//'\'')"'
alias sim='ros2 launch part_assembly_for_urdf_moveit_config demo.launch.py'
alias sim_headless='ros2 launch part_assembly_for_urdf_moveit_config demo.launch.py use_rviz:=false'
alias activate='ros2 run controller_manager spawner flipper_controller'
alias coordinator='ros2 run controller_manager spawner flipper_controller && ros2 launch part_assembly_for_urdf_coordinator coordinator.launch.py'
alias coordinator_launch='ros2 launch part_assembly_for_urdf_coordinator coordinator.launch.py'
alias arm_dump='candump -ta can_arm'
...
source /home/jontro_soinik_2_0-2/ros2_ws/install/setup.bash
