...
# Everything below this line is analysis output that runs only when the
# module is executed directly (python3 fk.py).  Gated so coordinator_node
# can import { fk, pos, ee_pitch_world } cleanly without prints firing.
if __name__ == '__main__':
    ...
    for tele_q in [0.0, -0.1, -0.2, -0.33982]:
        ...
        expected = L_base - tele_q
        print(f"  {tele_q:>+10.5f}  {L:>13.5f}  {expected:>26.5f}")

    # ---- 5) Telescope collinearity -----------------------------------------
